...
foreach (getEarlyBirdResults() as $result) {
  ...
  $finalsstring = $result[infinals] ?
    ($result[way]=="junior" ? "<span style=\"color:#555555\">Bästa junior</span>" : 
      ($result[way]=="female" ? "<span style=\"color:#555555\">Bästa dam</span>" : 
...
EOT;
  ...
  $color = $result[infinals] && $result[way]!="earlybird" ? "#AAAAAA" : ($i%2 == 0 ? "#FFFFFF" : "#EEEEFA");
  echo <<<EOT
