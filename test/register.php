  ...
  <div class="container">
    ...
    <p>
      ...
      <form id="player_form" action="doregisterstep2.php" method="post">
        ...
        <div class="row">
          <div class="col-md-4">
            <a class="btn btn-default" href="javascript:void()" role="button" id="formbutton">Sök</a><span style="font-weight:bold" id="working"></span>
          </div>
        </div>
        <div class="row">
    ...
    function bits_search(){
        ...
        $.post(
            "db/get_players_from_bits.php",
            {
                    ...
                    licens_number: document.getElementById("licens_number").value
            },
            function(data) {
...
//                $(sel).append(defaultop);
                ...
                $(arr).each(function(index,value){
                    var button = build_panel_button('javascript:void()',value.name + ", " + value.club + " (" + value.licens_number +")","true");
