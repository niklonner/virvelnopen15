...
$errormessages = array(
  ...
  "lastname" => "Efternamnet saknas eller innehåller ogiltiga tecken.",
  "club" => "Klubbnamnet saknas eller innehåller ogiltiga tecken.",
  "phonenumber" => "Telefonnumret saknas eller innehåller ogiltiga tecken.",
  ...
  "squad2passed" => "Det går inte längre att anmäla sig till start =.",
